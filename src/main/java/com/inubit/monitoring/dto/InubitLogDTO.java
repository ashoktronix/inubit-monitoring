...
public class InubitLogDTO {
    private String isGlobalPId;
    private Long isWorkflowId;
    private String isWorkflowName;
    private String isTag;
    private String isInputModule;
    private String isOutputModule;
    private Long isInputSize;
    private Long isOutputSize;
    ...
    public String getIsInputModule() {
        return this.isInputModule;
    }

    public void setIsInputModule(String isInputModule) {
        this.isInputModule = isInputModule;
    }

    public String getIsOutputModule() {
        return this.isOutputModule;
    }

    public void setIsOutputModule(String isOutputModule) {
        this.isOutputModule = isOutputModule;
    }

    public Long getIsInputSize() {
        return this.isInputSize;
    }

    public void setIsInputSize(Long isInputSize) {
        this.isInputSize = isInputSize;
    }

    public Long getIsOutputSize() {
        return this.isOutputSize;
    }

    public void setIsOutputSize(Long isOutputSize) {
        this.isOutputSize = isOutputSize;
    }
    ...
    public void setIsEndTime(Long isEndTime) {
